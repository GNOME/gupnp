 ...
 * @value: (out): The value
 *
 * Returns: The value of the current parameter. If the
 * service had a successful introspection, the type according to the
 * introspection data will be used, otherwise it will be string.
 */
